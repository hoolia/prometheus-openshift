/ee also [Elasticsearch+Kibana Kubernetes complete example](https://github.com/kayrus/elk-kubernetes)
...
## Security
```
oc adm policy add-scc-to-user hostaccess system:serviceaccount:monitoring:default
